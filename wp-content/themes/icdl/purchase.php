<!DOCTYPE html>
<!--
There is some conflict between the JavaScript used by Stripe and the
WordPress code so this Purchase page is not part of the WordPress site.
This purchase.php file should be linked to from the document root.
-->
<html>
<head>
	<title>PURCHASE ECDL - ECDL</title>
	<meta charset="utf-8">
...
<link rel="icon" href="https://www.ecdl.ie/wp-content/uploads/2017/06/cropped-ecdl_favicon-32x32.png" sizes="32x32" />
<link rel="icon" href="https://www.ecdl.ie/wp-content/uploads/2017/06/cropped-ecdl_favicon-192x192.png" sizes="192x192" />
...
<link rel='stylesheet' href='https://www.ecdl.ie/wp-content/themes/ecdl-ireland/assets/css/ittc16.css' />
...
<link rel='stylesheet' href='https://www.ecdl.ie/wp-content/plugins/font-awesome/assets/css/font-awesome.min.css' />
    ...
    <script src="assets/js/bootstrap.min35.js"></script>
	...
	$scope.fiveModuleToolkit2010 = [
    	...
    	$scope.fiveModuleToolkit2013 = [
									   ...
									   {type:"m2", mid: 1, id : 1728, title :"MS Office Toolkit",  version : 2013, price : 29900, desc : "ECDL Online Essentials, ECDL Word Processing, ECDL Spreadsheets, ECDL Presentation and ECDL Using Databases."},
    ...
    <nav class="navbar navbar-inverse" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="https://www.ecdl.ie/" >
                    <img src="assets/img/ecdl-ireland-logo.png" class="img-responsive center-block" />
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul id="main-navi" class="nav navbar-nav center-block ">
                ...
                <li id="menu-item-1333" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1333"><a title="BLOG" href="https://www.ecdl.ie/blog/">BLOG</a></li>
...
<div class="block-vertical block-buy-options block-achieve">
    <div class="container">
        <div class="row">
           <div class="col-md-6">
                <p class="lead">
                <b style="text-transform:uppercase" >Please note</b> If you purchase one of these toolkit you can sit your certificate tests in 87-89 Pembroke Road, Ballsbridge, Dublin 4 free of charge. If you go to another test centre to sit an exam you will be charged an invigilation fee by that centre.
                    <br/><br/>
                </p>
            </div>
            <div class="col-md-6">
                <p class="lead">
                <b style="text-transform:uppercase" >Toolkits include the following</b>- Skillscard for recording your results, access to an online learning account for 12 months, unlimited diagnostic tests, certificate tests with a free re-sit if a test is failed.
                    <br/><br/>
                </p>
            </div>
        </div>
...
<div id="ecdl-modules" class="block-list-of-modules">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				
				<p class="lead">
					<b><a href="assets/img/system-requirements-ics-skills.pdf">System Requirements</a></b><br/> 
				</p>
				</p>				
					A listing of software that workstations must be installed, with an easy-to-follow guide to setting up PCs to run the ICS Skills Learning Platform.
					Includes information on configuring pop-ups and MS Office macro security settings.
				</p>

			</div>
			<div class="col-md-6">
				<p class="lead">
					<b><a href="assets/img/java-free-browser-plugin-installation.pdf">Java-Free Browser Plugin Installation</a></b><br/> 
				</p>
				</p>				
			...
			<div class="row">
				<div class="col-sm-4 col-md-4">
					<div class="plan">
						...
						<label><input type="radio" name="optradio1" ng-click = "changeChoiceSingleModule()" ng-model="version.name" value="2010">&nbsp;Microsoft 2010</label>
						<label><input type="radio" name="optradio1" ng-click = "changeChoiceSingleModule()" ng-model="version.name" value="2013">&nbsp;Microsoft 2013</label>
				...
				<div class="col-sm-4 col-md-4 ">
					<div class="plan">
						...
						<p  class="buy-option-module">
						<label><input type="radio" name="optradio2" ng-click = "changeChoiceFiveModule()" ng-model="version.name" value="2010">&nbsp;Microsoft 2010</label>
						<label><input type="radio" name="optradio2" ng-click = "changeChoiceFiveModule()" ng-model="version.name" value="2013">&nbsp;Microsoft 2013</label>

						</p>

						<p>Choose a module bundle:</p>
				...
				<div class="col-sm-4 col-md-4">
					<div class="plan">
						<div class="head">
							...
							<p  class="buy-option-module">
						<label><input type="radio" name="optradio3" ng-model="version.name" value="2010">&nbsp;Microsoft 2010</label>
						<label><input type="radio" name="optradio3" ng-model="version.name" value="2013">&nbsp;Microsoft 2013</label>

						</p>
						<p>Purchase all the modules:</p>
...
<div id="footer_phone">
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                <p><strong><a href="http://www.ics.ie/ics/about">ECDL Ireland</a></strong></p>
            ...
            <div class="col-xs-6" >
                ...
                <p><a href="http://www.ics.ie/privacy">Privacy</a></p>
            </div>
        </div>
    </div>
</div>
